...
//    private String cv_file_tsync_id;
    ...
    public Applicant(String tsync_id, String name, String email, String phone, String full_address, String name_of_university, int graduation_year, float cgpa, int experience_in_months, String currrent_work_place_name, String applying_in, long expected_salary, String field_buzz_reference, String github_project_url, JsonObject cv_file, Long on_spot_update_time, Long on_spot_creation_time) {
